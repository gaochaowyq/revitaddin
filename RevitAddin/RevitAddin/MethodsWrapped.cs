...
namespace RevitAddin
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<RevitAddin.Ui>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
    ...
    public class EventHandlerWith_ImportRhinoFile : RevitEventWrapper<ImportRhinoFile>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, ImportRhinoFile ui)
        {
            // SETUP
            UIDocument uiDoc = uiApp.ActiveUIDocument;
            Document doc = uiDoc.Document;
            ...
            Methods.ImportRhinoBlock(ui, doc);
